...
const THEMES: AppThemes = {
  [Theme.Dark]: {
    colors: {
      ...
      buttonIconColor: color_canvas_inverted,
      buttonDimIconColor: color_canvas_inverted,
      buttonDimColor: hilite_canvas_primary,
      mapControlPanelColor: color_canvas_primary,
      mapControlExpanderColor: color_canvas_inverted,
      mapControlExpanderDimColor: color_canvas_inverted,
    },
    name: Theme.Dark,
  },
  [Theme.Light]: {
