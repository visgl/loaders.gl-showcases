...
export function getFrustumBounds(viewport) {
  ...
  const ntl = viewport.unprojectPosition(
    getIntersection(planes.near, planes.top, planes.left)
  );
  const ntr = viewport.unprojectPosition(
    getIntersection(planes.near, planes.top, planes.right)
  );
  const nbl = viewport.unprojectPosition(
    getIntersection(planes.near, planes.bottom, planes.left)
  );
  const nbr = viewport.unprojectPosition(
    getIntersection(planes.near, planes.bottom, planes.right)
  );
  const ftl = viewport.unprojectPosition(
    getIntersection(planes.far, planes.top, planes.left)
  );
  const ftr = viewport.unprojectPosition(
    getIntersection(planes.far, planes.top, planes.right)
  );
  const fbl = viewport.unprojectPosition(
    getIntersection(planes.far, planes.bottom, planes.left)
  );
  const fbr = viewport.unprojectPosition(
    getIntersection(planes.far, planes.bottom, planes.right)
  );
