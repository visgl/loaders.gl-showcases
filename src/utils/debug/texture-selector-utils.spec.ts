import { selectDebugTextureForTileset, selectOriginalTextureForTileset, selectDebugTextureForTile, selectOriginalTextureForTile } from './texture-selector-utils';
...
describe("Texture Selector Utils - selectOriginalTextureForTile", () => {
  ...
  test("Should add original texture to baseColorTexture and replace content material with material object", () => {
    ...
    expect(tile.content.material.pbrMetallicRoughness.baseColorTexture.texture.source.image).toStrictEqual('Original Texture');
