  ...
  test("Should return empty warnings if not LOD issues", () => {
    const tile = {
      ...
      parent: {
        ...
        children: [{ lodMetricValue: 50, boundingVolume: { radius: 5 } }],
        lodMetricValue: 10,
      },
    };
    const tileWarnings = [];
    ...
    expect(tileWarnings).toStrictEqual([
      {
        tileId: "parent Id",
        title:
          "Tile (parent Id) LOD/Radius ratio \"1000\" > mean child LOD/Radius ratio \"10\"",
  ...
  test("Should return only LOD/Radius ratio has large deviation from mean LOD/Radius ratio of neighbors warning", () => {
    ...
    expect(tileWarnings).toStrictEqual([
      ...
      },
      {
        tileId: "parent Id",
        title:
          "Tile (tile id) LOD/Radius ratio \"10000\" has large deviation from mean LOD/Radius ratio of neighbors \"10\"",
